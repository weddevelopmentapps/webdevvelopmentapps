...
(function () {
  ...
  P.permit = function (r) {
    ...
    var conditions = [
      "يلتزم المستفيد بنطاق الخدمة الموضح في هذا التصريح وبكافة الاشتراطات الفنية والبلدية ذات العلاقة.",
      "يُبرز هذا التصريح للجهات الرقابية عند الطلب، ولا يغني عن أي موافقات نظامية أخرى.",
      "تلتزم الجهة المستفيدة بإشعار الأمانة عن أي تغيير جوهري في نطاق الأعمال قبل تنفيذه.",
      "يخضع التصريح للإيقاف أو الإلغاء عند الإخلال بالاشتراطات وفق الأنظمة المرعية."
    ];
