...
(function () {
  ...
  var DICT = {
    ...
    "brand.tagline":         { ar: "بوابة واحدة، رحلة واضحة، قرار في موعده.", en: "One gateway. A clear journey. Decisions on time." },
    ...
    /* ---- landing ---- */
    "landing.heroTitle":      { ar: "مشاريع كبرى، بخدمات أكبر.", en: "Great projects deserve greater service." },
    "landing.heroSub":        { ar: "المنصة الموحدة لأمانة منطقة الرياض لتقديم ومتابعة الخدمات البلدية للمشاريع الكبرى والمطورين والمستثمرين ومديري الأصول — بحوكمة واضحة وأولوية معتمدة.", en: "Riyadh Region Municipality's unified platform for giga projects, developers, investors and asset managers — clear governance, committed priority." },
    "landing.cta":            { ar: "ابدأ طلبك", en: "Start a request" },
    "landing.explore":        { ar: "استعرض الخدمات", en: "Explore services" },
    "landing.journeyTitle":   { ar: "أين أنت في رحلة التطوير؟", en: "Where are you in the journey?" },
    "landing.journeySub":     { ar: "اختر مرحلتك لعرض الخدمات المناسبة لها", en: "Choose your phase to see its services" },
    "landing.servicesTitle":  { ar: "دليل الخدمات", en: "Service catalog" },
    "landing.servicesSub":    { ar: "خدمة بلدية موثقة بمتطلباتها ومددها الزمنية", en: "Documented municipal services with requirements and timelines" },
    "landing.howTitle":       { ar: "كيف تعمل المنصة؟", en: "How it works" },
    "landing.how1":           { ar: "سجّل مشروعك واختر الخدمة", en: "Register your project and pick a service" },
    "landing.how2":           { ar: "أكمل النموذج الذكي وأرفق المستندات", en: "Complete the smart form and attach documents" },
    "landing.how3":           { ar: "تابع طلبك بمدد زمنية ملتزمة", en: "Track your request against committed SLAs" },
    "landing.how4":           { ar: "استلم قرارك ووثيقتك الرسمية", en: "Receive your decision and official document" },
    ...
    "landing.entitiesTitle":  { ar: "بتكامل مع الجهات ذات العلاقة", en: "Coordinated with partner entities" },
    "landing.govTitle":       { ar: "حوكمة معتمدة من مكتب المشاريع الكبرى", en: "Governed by the Giga Projects Office" },
    "landing.govSub":         { ar: "مسار موحد، مسؤوليات واضحة، وتصعيد منضبط حتى مكتب الأمين", en: "One route, clear accountability, disciplined escalation to the Mayor's office" },
    ...
    "portal.noRequests":      { ar: "لا توجد طلبات بعد. ابدأ أول طلب خدمة لمشروعك.", en: "No requests yet. Start your first service request." },
    ...
    "wizard.declaration":     { ar: "أقر بصحة البيانات والمستندات المقدمة وأتحمل مسؤولية دقتها نظامًا.", en: "I declare the submitted information and documents are accurate and accept regulatory responsibility." },
    ...
    "wizard.fastTrackNote":   { ar: "هذا الطلب مؤهل لأولوية المشاريع الكبرى — مدة الإنجاز مخفضة", en: "Eligible for giga fast-track — reduced SLA applies" },
    ...
    "req.rate":               { ar: "قيّم تجربتك", en: "Rate your experience" },
    "req.rateThanks":         { ar: "شكرًا لتقييمكم — يسهم في تحسين الخدمة", en: "Thank you — your rating improves the service" },
    ...
    "work.claim":             { ar: "إسناد إليّ وبدء الفرز", en: "Claim & start screening" },
    ...
    "work.approveNote":       { ar: "سيصدر رقم وثيقة رسمي ويُشعر العميل فورًا.", en: "An official document number is issued and the customer is notified." },
    ...
    "work.returnNote":        { ar: "حدد بدقة ما يجب استكماله — تتوقف مدة الإنجاز حتى إعادة التقديم.", en: "List exactly what to complete — the SLA clock pauses until resubmission." },
    ...
    "work.rejectNote":        { ar: "الرفض قرار نهائي ويتطلب تسبيبًا وسندًا نظاميًا يُعرضان للعميل.", en: "Declining is final and requires a reason and regulatory reference shown to the customer." },
