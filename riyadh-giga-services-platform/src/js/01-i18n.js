...
(function () {
  ...
  var DICT = {
    ...
    /* ---- impact ---- */
    "impact.title":        { ar: "أثر المنصة", en: "Platform Impact" },
    "impact.subtitle":     { ar: "القيمة المتحققة لمدينة الرياض من تسريع خدمات المشاريع الكبرى", en: "Value generated for Riyadh by accelerating giga-project services" },
    "impact.methodology":  { ar: "المنهجية", en: "Methodology" },
    "impact.estimated":    { ar: "تقديري", en: "Estimated" },
    "impact.measured":     { ar: "مُقاس", en: "Measured" },
    "impact.nav":          { ar: "الأثر", en: "Impact" },
    "impact.zeroState":    { ar: "تُحتسب المؤشرات فور إنجاز أول طلب", en: "Indicators appear once the first request is completed" },

    /* ---- personalization ---- */
    "prefs.title":         { ar: "تخصيص المظهر", en: "Personalize" },
    "prefs.appearance":    { ar: "المظهر", en: "Appearance" },
    "prefs.light":         { ar: "فاتح", en: "Light" },
    "prefs.dark":          { ar: "داكن", en: "Dark" },
    "prefs.auto":          { ar: "تلقائي", en: "Auto" },
    "prefs.accent":        { ar: "لون الهوية", en: "Accent color" },
    "prefs.accentGreen":   { ar: "الأخضر السيادي", en: "Sovereign Green" },
    "prefs.accentSand":    { ar: "ذهب الرمال", en: "Sand Gold" },
    "prefs.accentTeal":    { ar: "أزرق الوادي", en: "Wadi Teal" },
    "prefs.accentViolet":  { ar: "بنفسج المخطوطات", en: "Manuscript Violet" },
    "prefs.density":       { ar: "الكثافة", en: "Density" },
    "prefs.comfortable":   { ar: "مريحة", en: "Comfortable" },
    "prefs.compact":       { ar: "مضغوطة", en: "Compact" },
    "prefs.fontSize":      { ar: "حجم الخط", en: "Text size" },
    "prefs.reset":         { ar: "إعادة التعيين إلى الافتراضي", en: "Reset to defaults" },

    /* ---- command palette ---- */
    "pal.placeholder":     { ar: "ابحث أو نفّذ أمرًا…", en: "Search or run a command…" },
    "pal.actions":         { ar: "إجراءات", en: "Actions" },
    "pal.navigate":        { ar: "تنقّل", en: "Navigate" },
    "pal.requests":        { ar: "طلبات", en: "Requests" },
    "pal.projects":        { ar: "مشاريع", en: "Projects" },
    "pal.services":        { ar: "خدمات", en: "Services" },
    "pal.recent":          { ar: "الأخيرة", en: "Recent" },
    "pal.noResults":       { ar: "لا نتائج للبحث", en: "No results" },
    "pal.noResultsSub":    { ar: "جرّب رقم الطلب أو اسم الخدمة أو المشروع.", en: "Try a request number, service, or project name." },
    "pal.newRequest":      { ar: "طلب خدمة جديد", en: "New request" },
    "pal.switchLang":      { ar: "تبديل اللغة", en: "Switch language" },
    "pal.toggleTheme":     { ar: "تبديل المظهر", en: "Toggle theme" },
    "pal.personalize":     { ar: "تخصيص المظهر", en: "Personalize" },
    "pal.signOut":         { ar: "تسجيل الخروج", en: "Sign out" }
  };
