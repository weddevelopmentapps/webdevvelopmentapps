...
KPIS = [
    ...
    # «الأسرّة» بالشدّة — تطبيق البند 1 من القسم 1 في ARABIC_COPY_REVIEW.md
    # (بلا شدّة تلتبس بالأُسَر/العائلات؛ تصنيف السجل: إملائي لا يحتاج موافقة)
    (5, "عدد الأسرّة المرخصة في مدينة الرياض", "استراتيجي", 130_000, 260_000, False),
...
INSIGHT_PANELS = {
    ...
    "control": [
        ...
        # نص موجز يتسع كاملاً في بطاقة الرؤية (مراجعة الجولة 3: كانت التوصية
        # تُقص منتصف الجملة عند حافة البطاقة في كلا المقاسين)
        ("cd3", "neu", "مراجعة خطة الانتشار الميداني",
         "يوصى بإعادة توزيع المراقبين وفق كثافة المخالفات المسجلة لكل قطاع."),
    ],
    "initiatives": [
        ...
        # نص موجز يتسع كاملاً في بطاقة الرؤية (مراجعة الجولة 3: كانت البطاقة
        # عنواناً مبتوراً عند الطية وجسدها ضائعاً تحت إطار العرض)
        ("id3", "neu", "تسع مبادرات جاري العمل عليها",
         "تمتد المبادرات التسع الجارية حتى أبريل 2027، وأطولها مدةً تقنين السكن غير المرخص وإلزام التسكين المرخص."),
    ],
}
