...
// سجل التبويبات المؤجَّل: ‎RH.tabs.register‎ موجود **قبل** قشرة التبويبات نفسها،
// فتسجيل أي تبويب لا يعتمد على موضع ملفه في ‎JS_ORDER‎ ولا يحتاج حارساً عند
// نداء التسجيل. القشرة (‎presenter/tabs.js‎) تستبدل هذا الكائن بالوحدة الحقيقية
// وتصرِّف ‎_pending‎ فور تعريفها، فلا تسجيلٌ يضيع صامتاً ولا ترتيبٌ يكسر البناء.
RH.tabs = {
  _pending: [],
  register(def) { this._pending.push(def); },
};
