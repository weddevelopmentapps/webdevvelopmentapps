...
RH.presenter.chrome = (function () {
   ...
   * الشريط بموضع CSS مستقل: الحافة العلوية الوسطى بين زرّي التقليب، وهي
   * الفراغ الوحيد المضمون في كل لوحة وملحق (ترويسة اللوحة تشغل الزاويتين
   * فقط). التفصيل وسبب استبعاد الزاويتين السفليتين في chrome-ext.css.
   */
