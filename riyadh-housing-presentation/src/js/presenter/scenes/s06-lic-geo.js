  ...
  function build(host, ctx) {
    ...
    host.appendChild(h("section", {
      ...
      h("h2", { class: "sc-headline rise" },
        "يتصدر قطاع الشرق رخص البناء والرخص التشغيلية والطاقة الاستيعابية المرخصة"),
      h("div", { class: "sc-implication rise", style: { marginTop: "calc(var(--su)*10)" } },
        rel.insights.s06.text),
      h("div", { class: "sc-body rise", style: { marginTop: "calc(var(--su)*24)" } }, mapBox),
