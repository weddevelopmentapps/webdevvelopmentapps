...
BOX = {"القطاع الشمالي":(20,80,9,24),"القطاع الشرقي":(68,90,33,62),"القطاع الأوسط":(40,60,35,56),
       "القطاع الغربي":(12,32,33,58),"القطاع الجنوبي":(22,78,68,90)}
...
# ----------------------------------------------------------------------------
PILLARS=["التنظيمات واللوائح","التطوير العمراني","الاستثمار والقطاع الخاص","الرقابة والامتثال","الحوكمة","التحول الرقمي","التواصل والتوعية"]
OWNERS={"التنظيمات واللوائح":"إدارة التنظيمات البلدية","التطوير العمراني":"الإدارة العامة للتخطيط العمراني",
 "الاستثمار والقطاع الخاص":"إدارة الاستثمار والشراكات","الرقابة والامتثال":"الإدارة العامة للرقابة الميدانية",
 "الحوكمة":"مكتب الحوكمة والالتزام","التحول الرقمي":"إدارة التحول الرقمي","التواصل والتوعية":"إدارة التواصل المؤسسي"}
INIT_DEFS={
 "التنظيمات واللوائح":[
  ("تحديث لائحة اشتراطات سكن العمالة الجماعي","في المسار",78,"2025-03-01","2026-11-25",4_200_000,"اعتماد النسخة النهائية من اللجنة العليا","منخفض","رفع نسبة المنشآت المتوافقة إلى 85٪"),
  ("إطار تصنيف مقدمي خدمات الإسكان العمالي","في المسار",55,"2025-06-15","2027-01-31",2_800_000,"إطلاق التصنيف التجريبي لـ 40 منشأة","متوسط","تحفيز رفع جودة المرافق عبر التصنيف المعلن"),
 ...
 "التطوير العمراني":[
  ("مخطط المناطق النموذجية لإسكان العمالة (المرحلة الأولى)","في المسار",64,"2025-02-01","2027-03-31",38_000_000,"اعتماد المخطط التفصيلي للموقع الجنوبي","متوسط","إضافة 45,000 سرير مرخص جديد"),
 ...
 "الاستثمار والقطاع الخاص":[
  ("طرح 6 فرص استثمارية لمجمعات سكن عمالة","في المسار",59,"2025-05-01","2027-02-28",5_400_000,"إغلاق التأهيل المسبق للمطورين","متوسط","استقطاب استثمارات بـ 1.2 مليار ريال"),
 ...
 "الحوكمة":[
  ("مكتب إدارة بيانات سكن العمالة","في المسار",74,"2025-03-10","2026-11-30",2_900_000,"إطلاق قاموس البيانات الموحد","منخفض","مصدر واحد موثوق لكل مؤشرات القطاع"),
 ...
 "التحول الرقمي":[
  ("منصة الترخيص الإلكتروني الموحد لسكن العمالة","في المسار",91,"2024-12-01","2026-08-25",12_500_000,"إطلاق خدمة رخص البناء رقمياً","منخفض","إصدار 95٪ من الرخص إلكترونياً"),
  ("التوأم الرقمي لمواقع سكن العمالة","في المسار",57,"2025-05-15","2027-05-31",9_800_000,"مسح ثلاثي الأبعاد لأول 200 منشأة","متوسط","خفض زيارات التحقق الميدانية 35٪"),
 ...
 "التواصل والتوعية":[
  ...
  ("ملتقى الرياض السنوي لإسكان العمالة","متوقفة",18,"2025-06-01","2026-11-15",3_200_000,"تحديد موعد وشركاء النسخة الأولى","متوسط","منصة سنوية للقطاعين العام والخاص"),
 ],
}
initiatives=[]; iid=1
for p in PILLARS:
...
# ----------------------------------------------------------------------------
GEO={
 "القطاع الشمالي":{"poly":[[12,6],[50,3],[88,7],[84,24],[62,28],[38,28],[16,23]],"label":[50,16]},
 "القطاع الغربي":{"poly":[[8,27],[34,31],[35,60],[27,66],[9,61],[5,42]],"label":[21,46]},
 "القطاع الأوسط":{"poly":[[38,31],[62,31],[63,57],[51,62],[38,57]],"label":[50,45]},
 "القطاع الشرقي":{"poly":[[66,30],[88,26],[96,44],[93,65],[72,68],[66,57]],"label":[80,47]},
 "القطاع الجنوبي":{"poly":[[12,64],[30,63],[50,66],[70,71],[89,70],[85,92],[56,98],[22,91],[10,78]],"label":[49,80]},
}
...
# ----------------------------------------------------------------------------
DATA={
 "meta":{"title":"لوحة معلومات سكن العمالة","entity":"أمانة منطقة الرياض — وكالة سكن العمالة",
...
sheet("README",["الحقل","الوصف"],[
 ["الجهة","أمانة منطقة الرياض — وكالة سكن العمالة (بيانات تجريبية لأغراض العرض)"],
 ...
 ["Initiatives / KPIs / Predictions","28 مبادرة على 7 ركائز، 14 مؤشر أداء، وتوقعات 12 شهراً بثلاثة سيناريوهات"],
